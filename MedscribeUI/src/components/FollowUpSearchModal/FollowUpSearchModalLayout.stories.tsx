...
const FollowUpSearchModalWithState = () => {
  const [selectedVisit, setSelectedVisit] = useState<SearchResultItem | null>(
    null,
  );
  ...
  return (
    <div className="p-8">
      <FollowUpSearchModalLayout handleSelectedVisit={handleSelectedVisit}>
      ...
      <div className="mt-8 p-4 border border-gray-200 rounded-lg">
        ...
        {selectedVisit ? (
          <div className="text-gray-700">
            ...
            <p>
              <strong>Date:</strong> {selectedVisit.dateOfRecording}
            </p>
            <p>
              <strong>Summary:</strong> {selectedVisit.summary}
            </p>
          </div>
        ) : (
